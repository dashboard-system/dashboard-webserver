...
// Mock data
let users: User[] = [
  { id: 1, name: 'John Doe', email: 'john@example.com', role: 'user', createdAt: '2024-01-01T00:00:00Z' },
  { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'user', createdAt: '2024-01-02T00:00:00Z' },
  { id: 3, name: 'Bob Johnson', email: 'bob@example.com', role: 'admin', createdAt: '2024-01-03T00:00:00Z' }
];
...
router.get('/:id', requireRole(['admin']), (req: AuthRequest, res: Response): void => {
  const { id } = req.params;
